"""
The author of the layer classes is Yselivonchyk
See: https://github.com/yselivonchyk/Tensorflow_WhatWhereAutoencoder

Minor adjustments were made to save the models with these layers in newer versions of tensorflow.
"""
